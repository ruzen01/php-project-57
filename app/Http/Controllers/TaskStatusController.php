...
class TaskStatusController extends Controller
{
    ...
    public function update(Request $request, TaskStatus $task_status)
    {
        ...
        return redirect()->route('task_statuses.index')->with('success', 'Статус успешно обновлен');
    }
    ...
    public function destroy(TaskStatus $task_status)
    {
        ...
        return redirect()->route('task_statuses.index')->with('success', 'Статус успешно удален');
    }
}
